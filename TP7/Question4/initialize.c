...
/*
La procédure nulluser est le point d'entré du programme.
...
la main ce thread vérifie que la alive_list n'est pas vide. Si elle n'est
...
void sysinit()
{
  ...
  threadptr->name = (char*) malloc(10*sizeof(char));
